...
function Navbar() {
    ...
    react_1.useEffect(function () {
        ...
        notificationDb.orderByChild('sendTo').equalTo(user.uid).on('value', function (notify) {
            if (notify.val()) {
                var realNotification = Object.values(notify.val()).filter(function (checkStatus) { return checkStatus.status === 'pending'; });
    ...
    return (react_1["default"].createElement("div", { className: "bg-white flex z-40  h-14 shadow-lg fixed w-full  top-0" },
        ...
        react_1["default"].createElement("div", { className: "flex w-1/2  justify-evenly items-center " },
            ...
            react_1["default"].createElement(bs_1.BsLayoutTextSidebarReverse, { className: "text-3xl text-gray-400" }),
            react_1["default"].createElement("span", { className: "cursor-pointer", onClick: openRequestMOdel },
                " ",
            ...
            react_1["default"].createElement(bs_1.BsFillPeopleFill, { className: "text-3xl text-gray-400" })),
        react_1["default"].createElement(RequestComponent_1["default"], { model: model })));
}
